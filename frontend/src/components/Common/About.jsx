  ...
  return (
    <div style={{ padding: "40px", maxWidth: "900px", margin: "0 auto" }}>
      <Card bordered={false} style={{ textAlign: "center", padding: "30px" }}>
        <Title level={2}>Welcome to DimeCine 🎬</Title>
        <Paragraph style={{ marginTop: "20px", fontSize: "16px" }}>
          DimeCine is your ultimate destination for sharing, reviewing, and
          discovering movies and cinematic gems. Whether you're a casual viewer
          or a hardcore cinephile, DimeCine provides a platform to rate,
        ...
        <Paragraph style={{ fontSize: "16px" }}>
          ...
          review you write — it becomes part of the DimeCine universe!
        </Paragraph>

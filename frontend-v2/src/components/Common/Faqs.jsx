      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="mn-accordion style-1">
            ...
            <div class="mn-accordion-item">
              <h4 class="mn-accordion-header">Refund policy for customer.</h4>
              <div class="mn-accordion-body">
                Lorem Ipsum is simply dummy text of the printing and typesetting
            ...
            <div class="mn-accordion-item">
              <h4 class="mn-accordion-header">Exchange policy for customer.</h4>
              <div class="mn-accordion-body">
                Lorem Ipsum is simply dummy text of the printing and typesetting
                industry. Lorem Ipsum has been the industry's standard{" "}
            ...
            <div class="mn-accordion-item">
              ...
              <div class="mn-accordion-body">
                ...
                the 1500s. unknown printer took a galley of type and scrambled
